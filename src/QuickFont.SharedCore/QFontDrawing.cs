...
namespace QuickFont.SharedCore
{
    ...
    public class QFontDrawing : IDisposable
    {
        ...
        private static void InitialiseStaticState()
        {
            ...
            string[]? versions = new[] { SHADER_VERSION_STRING130, SHADER_VERSION_STRING140, SHADER_VERSION_STRING150 };
            ...
            ShaderLocations? shaderVariables = new ShaderLocations
            {
                ShaderProgram = prog,
            ...
            QFontSharedState? sharedState = new QFontSharedState(TextureUnit.Texture0, shaderVariables);
        ...
        public void Draw()
        {
            ...
            foreach (QFontDrawingPrimitive? primitive in _glFontDrawingPrimitives)
            {
        ...
        {
            QFontDrawingPrimitive? dp = new QFontDrawingPrimitive(font, opt);
        ...
        {
            QFontDrawingPrimitive? dp = new QFontDrawingPrimitive(font);
            DrawingPrimitives.Add(dp);
