...
namespace QuickFont.SharedCore
{
    ...
    static class KerningCalculator
    {
        ...
        {
            Dictionary<string, int>? kerningPairs = new Dictionary<string, int>();
            ...
            {
                Rectangle rect = glyphs[n].Rect;
                QBitmap? page = bitmapPages[glyphs[n].Page];
            ...
            XLimits[]? tmp = new XLimits[maxHeight+1];
