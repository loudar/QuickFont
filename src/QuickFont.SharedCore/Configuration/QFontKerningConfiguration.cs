namespace QuickFont.SharedCore.Configuration
{
    /// <summary>
    /// Kerning Rules
    /// </summary>
    ...
    public class QFontKerningConfiguration
    {
        ...
        public CharacterKerningRule GetOverridingCharacterKerningRuleForPair(string str)
        {
            ...
            if (GetCharacterKerningRule(c1) == CharacterKerningRule.NotMoreThanHalf || GetCharacterKerningRule(c2) == CharacterKerningRule.NotMoreThanHalf)
            {
